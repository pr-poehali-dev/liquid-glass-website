...
const Index = () => {
  ...
  const mainModules = [
    { id: 1, title: 'Добавление информации', icon: 'PlusCircle', gradient: 'from-blue-400/30 to-cyan-400/30' },
  ...
  const documentsInWork = [
    { id: 1, number: '5801', title: 'Приказ о внесении изменений', type: 'Приказ', date: '15.12.2024', status: 'На согласовании' },
    { id: 2, number: '5802', title: 'Распоряжение о проведении мероприятий', type: 'Распоряжение', date: '16.12.2024', status: 'Черновик' },
    { id: 3, number: '5803', title: 'Служебная записка о выделении средств', type: 'Записка', date: '17.12.2024', status: 'Доработка' },
  ];
